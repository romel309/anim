...
<script type="text/javascript">
      ...
      'use strict';
          jQuery('body').backstretch([
            "visitor/images/bg/madoka.jpg",
            "visitor/images/bg/hanelc.jpg",
            "visitor/images/bg/asuka.jpg",
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="carousel-content center centered">
                                    ...
                                    <h2 class="boxed animation animated-item-1 fade-down">40Y20</h2>
                                    <br>
                                    <a class="btn btn-md animation bounce-in" href="#services">Recomendations</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="center gap fade-down section-heading">
                            <h2 class="main-title">¿Por qué existe esto?</h2>
                            <hr>
                            <p>Hice un tutorial de laravel y pues pensé en reutilizar el codigo para hacer listas de cualquier cosa sale saludos.</p>
                        </div>
                    </div>
                </div>
	                                    ...
	                                    <blockquote>
	                                        <div class="row">
	                                            <div class="col-sm-3 text-center">
	                                                <img class="img-responsive" src="visitor/images/team/team01.jpg" style="width: 100px;height:100px;">
	                                            </div>
	                                            <div class="col-sm-9">
	                                                <p>Cuarenta y veinte es el amor lo que importa y no Lo que diga la gente</p>
               ...
               <div class="gap"></div>
                <div class="row fade-up">
                    <div class="col-md-6">
                        ...
                        <img class="pull-left img-responsive quote-author-list" src="visitor/images/team/team01.jpg">
                            <blockquote>
	            ...
	            <div class="center gap fade-down section-heading">
	                ...
	                <hr>
	                <p>No importa que a mi no me entiendan y que por lo bajo comenten que existe una gran diferencia</p>
	            </div>
	            <div class="gap"></div>
	                ...
	                <div class="col-md-3 col-xs-6">
	                    <div class="center team-member">
                            <div class="team-image">
                                <img class="img-responsive img-thumbnail bounce-in" src="visitor/images/team/team01.jpg" alt="">
                                <div class="overlay">
                                    <a class="preview btn btn-outlined btn-primary" href="visitor/images/team/team01.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i></a>
                                </div>
                            </div>
...
<ul class="portfolio-filter fade-down center">
            ...
            <section id="blog" class="white">
                <div class="container">
                    <div class="center gap fade-down section-heading">
                   		<div class="gap"></div>
                        <h2 class="main-title">Nuevas Series</h2>
                        <hr>
