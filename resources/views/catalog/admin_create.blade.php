        ...
        <div class="row">
          ...
          <div class="col-lg-12 col-md-12">
            <div class="form-group">
                ...
                <textarea class="form-control" name="description" id="description" maxlength="2000" rows="12" placeholder="Esta lista sirve para mostrar mi top 10 de series donde existen relaciones amorosas de una gran diferencia de edad." required>{{ old('description')}}</textarea>
            </div>
          </div>
        </div>
      </div>
