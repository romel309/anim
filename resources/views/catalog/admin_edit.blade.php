      ...
      <div class="col-lg-6 col-md-6">
        <div class="fileinput fileinput-new text-center" data-provides="fileinput">
          <div class="fileinput-new thumbnail img-raised">
              <img class="img-fluid" src="{{asset($catalog->thumbnail)}}" alt="image_preview">
          </div>
        ...
        <div class="row">
          <div class="col-lg-12 col-md-12">
            <div class="form-group">
              ...
              <input type="text" name="name" required class="form-control" maxlength="50" id="name" aria-describedby="nameHelp" placeholder="Top 10 40y20" value="{{ $catalog->name}}">
            </div>
          </div>
          <div class="col-lg-12 col-md-12">
            <div class="form-group">
      ...
      <div class="col-lg-12 col-md-12 text-center">
        ...
        <div class="form-check form-check-inline">
          <label class="form-check-label">
            <input class="form-check-input" type="checkbox" id="{{$entertainment->name}}" name="ente[]" value="{{$entertainment->id}}"
            @foreach($checked as $check)
              @if($entertainment->id == $check)
                checked
              @endif
            @endforeach
            > {{$entertainment->name}}
